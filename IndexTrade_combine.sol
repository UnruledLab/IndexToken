 ...
 */
contract IndexToken is StandardToken, Ownable {

  string public constant name = "IndexToken";
  string public constant symbol = "IndexToken";
...
contract Crowdsale is Ownable {
  ...
  function createTokenContract() internal returns (IndexToken) {
